package com.cxcacm.file.aspect;
...
import static com.cxcacm.file.constants.FileConstants.CANT_LOG_ARGS;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.cxcacm.file.annotation.SystemLog)")
    public void pt() {
    ...
    private void handleBefore(ProceedingJoinPoint joinPoint) {
        ...
        // 打印请求入参
        log.info("Request Args   : {}", CANT_LOG_ARGS);
    }
